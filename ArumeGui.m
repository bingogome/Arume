classdef ArumeGui < handle
    ...
    methods 
        ...
        function menuFileCallback( this, source, eventdata )
            ...
            for i=1:length(this.arume.recentProjects) % Add recent projects
                uimenu(this.menuFileLoadRecentProject, ...
                'Label'     , this.arume.recentProjects{i}, ...
                'Callback'  , @this.loadProject);
            end
        end
            ...
            if ( ~isempty( this.arume.currentProject ) )
                ...
                for i=1:length( this.arume.currentProject.sessions )
                    sessionNames{i} = sprintf('%-15.15s %-8.8s %-10.10s', ...
                        this.arume.currentProject.sessions(i).experiment.Name, ...
                        this.arume.currentProject.sessions(i).subjectCode, ...
                        this.arume.currentProject.sessions(i).sessionCode);
                end
