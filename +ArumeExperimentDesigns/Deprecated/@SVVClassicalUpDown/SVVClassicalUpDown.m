...
%                     
    ...
    methods ( Access = public )
        function analysisResults = Plot_SVVupdown(this)
            ...
            text(10, 5, sprintf('SVV UP: %0.2f°',mean(ds.Response(streq(ds.Position,'Up'))')), 'fontsize',16);
            text(10, 0, sprintf('SVV DOWN: %0.2f°',mean(ds.Response(streq(ds.Position,'Down'))')), 'fontsize',16);
